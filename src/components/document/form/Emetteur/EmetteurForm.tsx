...
interface EmetteurFormProps extends EmetteurProps {
	setShowForm: (show: boolean) => void;
}

export default function EmetteurForm({
	setSearchTriggered,
	handleChangeData,
	data,
	setShowForm,
	...
	const handleSave = async () => {
		...
		try {
			...
			console.log('Emetteur saved successfully:', result);
			setShowForm(false);
		} catch (error) {
			console.error('Error saving emetteur:', error);
		}
